...
export function StackMarquee({ tags, className }: StackMarqueeProps) {
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={cn(
        "group/marquee no-scrollbar neo-border bg-card relative w-full overflow-hidden overscroll-x-contain py-2 outline-none focus-visible:ring-2 focus-visible:ring-foreground hover:overflow-x-auto focus-within:overflow-x-auto",
        className,
      )}
    >
      <div
